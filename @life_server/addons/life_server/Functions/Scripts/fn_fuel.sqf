...
while {true} do {
	...
	switch(true)do
	{
		...
		case (_vehicle iskindof "C_Hatchback_01_sport_F"): {_rate = 0.00025;}; //ok
		...
		//Cop Bewaffnete
		case (_vehicle iskindof "B_MRAP_01_F"): {_rate = 0.00026;};  // Hunter
		case (_vehicle iskindof "B_MRAP_02_hmg_F"): {_rate = 0.00060;};  // Hunter HMG
		case (_vehicle iskindof "O_MRAP_02_F"): {_rate = 0.00060;};  // Ifrit
		case (_vehicle iskindof "O_MRAP_02_hmg_F"): {_rate = 0.00060;};  // Ifrit HMG
		case (_vehicle iskindof "I_MRAP_03_F"): {_rate = 0.00060;};  // Strider
		case (_vehicle iskindof "B_G_Offroad_01_F"): {_rate = 0.00060;};
