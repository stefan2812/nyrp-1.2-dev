...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			case "oil_unprocessed": {"life_inv_oilu"};
			case "oil_processed": {"life_inv_oilp"};
			case "heroin_unprocessed": {"life_inv_heroinu"};
			case "heroin_processed": {"life_inv_heroinp"};
			...
			case "copper_ore": {"life_inv_copperore"};
			case "iron_ore": {"life_inv_ironore"};
			case "iron_ingot": {"life_inv_ironr"};
			case "copper_ingot": {"life_inv_copperr"};
			case "salt": {"life_inv_salt"};
			case "salt_refined": {"life_inv_saltr"};
			...
			case "diamond_cut": {"life_inv_diamondr"};
			case "cocaine_unprocessed": {"life_inv_coke"};
			case "cocaine_processed": {"life_inv_cokep"};
			...
			case "nanobots": {"life_inv_nanobots"};
		};
	};
