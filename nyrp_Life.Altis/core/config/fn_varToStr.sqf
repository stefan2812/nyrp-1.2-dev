...
switch (_var) do
{
	...
	case "life_inv_heroin_unprocessed": {(localize "STR_Item_HeroinU")};
	case "life_inv_heroin_processed": {(localize "STR_Item_HeroinP")};
	...
	case "life_inv_iron_ingot": {(localize "STR_Item_IronIngot")};
	case "life_inv_copper_ingot": {(localize "STR_Item_CopperIngot")};
	...
	case "life_inv_diamond_cut": {(localize "STR_Item_DiamondC")};
	...
	case "life_inv_cocaine_unprocessed": {(localize "STR_Item_CocaineU")};
	case "life_inv_cocaine_processed": {(localize "STR_Item_CocaineP")};
