...
//Check that you are near a place to jail them.police_hq_2
if(!((player distance (getMarkerPos "Police HQ_1") < 75) OR  (player distance (getMarkerPos "cop_spawn_4") < 75) OR  (player distance (getMarkerPos "police_hq_2") < 75) OR (player distance (getMarkerPos "cop_spawn_3") < 75) OR (player distance (getMarkerPos "cop_spawn_5") < 75))) then  {
