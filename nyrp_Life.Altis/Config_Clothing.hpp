...
class Clothing {
	...
	class cop {
		...
		uniforms[] = {
			{ "NONE", "Remove Uniform", 0, { "", "", -1 } },
			{ "U_Rangemaster", "Streifen Uniform", 200, { "", "", -1 } },
			{ "U_B_CombatUniform_mcam", "Einsatz Uniform", 300, { "life_coplevel", "SCALAR", 2 } },
			{ "U_O_OfficerUniform_ocamo", "PolizeiVorstand", 1250, { "life_coplevel", "SCALAR", 6 } }
		};

		headgear[] = {
			{ "NONE", "Remove Hat", 0, { "", "", -1 } },
			{ "H_Beret_blk_POLICE", "", 1000, { "life_coplevel", "SCALAR", 3 } },
			{ "H_Cap_police", "", 750, { "life_coplevel", "SCALAR", 2 } }
		};
		...
		vests[] = {
			...
			{ "V_PlateCarrier2_blk", "AntiGas Weste", 1500, { "life_coplevel", "SCALAR", 1 } }
		};

		backpacks[] = {
			{ "NONE", "Remove Backpack", 0, { "", "", -1 } },
			{ "B_Bergen_mcamo", "", 800, { "", "", -1 } },
			{ "B_Carryall_cbr", "", 3500, { "life_coplevel", "SCALAR", 3 } }
		};
	};
	...
	class reb {
		...
		uniforms[] = {
			...
			{ "U_O_PilotCoveralls", "", 25610, { "", "", -1 } },
			{ "U_IG_leader", "Guerilla Leader", 25340, { "", "", -1 } },
		...
		vests[] = {
			{ "NONE", "Remove Vest", 0, { "", "", -1 } },
			{ "V_TacVest_khk", "AntisGas Weste", 55000, { "", "", -1 } },
