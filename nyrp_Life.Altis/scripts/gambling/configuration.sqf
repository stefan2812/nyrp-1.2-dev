...
//Gambling config
//////////////////////////////////
king_gamble_roll_time                               = 6; //the duration of one gamble (how long the dice rolls) only animation stuff but don´t try 0... ;o)
king_gamble_max_bet                                 = 2000000; //Dollar
...
king_gamble_add_lost_money_to_the_jackpot_percent   = 50; //Soviel Prozent vom verlorenen Geld kommt in den Jackpot
...
king_gamble_reroll_if_won_factor_dice               = 6;  //0...10 (0=never; 10=everytime)
...
//Dice
king_gamble_dice_win_factor_two_of_a_kind       = [5,   8,    203];   //Pasch beim Würfeln
king_gamble_dice_win_factor_sum_seven           = [2,    4,   2004];  //Summe 7 beim Würfeln
...
king_gamble_you_have_been_watched_gambling_illegal          = "Ein Spitzel hat Videomaterial an die Polizei weitergereicht! Die FAHNDUNG LÄUFT!";
...
king_gamble_jackpot_rules_text                              = "(Gewinn bei Slotmaschine 3x<img size='1.0' image='icons\gambling\slot_001.paa'/>)"; //vor dem Text steht immer der Name des Spielers
