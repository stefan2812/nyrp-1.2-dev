...
switch (_side) do
{
	case west:
	{
		_return = [
			...
			["cop_spawn_5","Neochori HQ","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"],
			["cop_spawn_6","Paros HQ","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"]
		];
	};
	...
	case civilian:
	{
		...
		_return pushBack ["rebelop_1","Rebellenlager","\a3\ui_f\data\map\MapControl\watertower_ca.paa"];
		};
